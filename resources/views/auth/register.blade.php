...
.btn {
  ...
  .btn.btn-primary {
    ...
    background: linear-gradient(135deg, #f75959 0%, #f35587 100%);
    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#f75959', endColorstr='#f35587', GradientType=1 );
    border: 1px solid #f35587 !important;
    color: #fff !important; }
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
		      	...
		      	<div class="img" style="background-image: url('https://cdn.landesa.org/wp-content/uploads/default-user-image.png');"></div>
